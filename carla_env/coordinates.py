...
def train_coordinates(task_mode):
    starts = {
        ...
        'TrafficLight': [[-6.503955841064453, 53.60614776611328, 0.5, 0.0, 89.63745880126953, 0.0],
                         [-10.003886222839355, 53.628292083740234, 0.5, 0.0, 89.63745880126953, 0.0]],
    }
    ...
    dests = {
        ...
        'Lane': [
            [68.09, 187.91, 0.5, 0.0, 0.0, 180.29],  # 0
            # [189.07, -68.89, 0.5, 0.0, 0.0, 89.33],  # 230
            # [177.81, -140.75, 0.5, 0.0, 0.0, 61.30],  # 150
        ...
        'TrafficLight': [[-5.855019569396973, 156.1641082763672, 0.5, 0.0, 89.63745880126953, 0.0],
                         [-9.354949951171875, 156.18624877929688, 0.5, 0.0, 89.63745880126953, 0.0]],
    }
